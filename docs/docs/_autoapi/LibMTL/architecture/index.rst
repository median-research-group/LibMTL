...
.. py:class:: AbsArchitecture(task_name, encoder, decoders, rep_grad, multi_input, device, **kwargs)
   ...
   .. py:method:: forward(self, inputs, task_name=None)
      ...
      The forward function of an architecture.
...
.. py:class:: HPS(task_name, encoder, decoders, rep_grad, multi_input, device, **kwargs)
...
.. py:class:: Cross_stitch(task_name, encoder, decoders, rep_grad, multi_input, device, **kwargs)
...
.. py:class:: MMoE(task_name, encoder, decoders, rep_grad, multi_input, device, **kwargs)
...
.. py:class:: MTAN(task_name, encoder, decoders, rep_grad, multi_input, device, **kwargs)
...
.. py:class:: CGC(task_name, encoder, decoders, rep_grad, multi_input, device, **kwargs)
...
.. py:class:: PLE(task_name, encoder, decoders, rep_grad, multi_input, device, **kwargs)
...
.. py:class:: DSelect_k(task_name, encoder, decoders, rep_grad, multi_input, device, **kwargs)
