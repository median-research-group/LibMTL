...
```eval_rst
There are four important functions in :class:`LibMTL.architecture.AbsArchitecture`. We will introduce them in detail as follows.
...
- :func:`get_share_params`: This function is used to return the shared parameters of the model. It returns all the parameters of encoder by default. You can rewrite it if necessary.
